window.onload = () => {
	...
	document.getElementById("getReimButton").addEventListener("click", getReimById);
	//getAllReims();
...
const createReims = () => {
	...
	xhr.open("POST", "http://localhost:8081/ERS/GetReimById");
